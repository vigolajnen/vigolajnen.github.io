...
const breakpointProfit = window.matchMedia('(min-width:567px)');
...
const btnCoachGallery = document.querySelector('.certificate');
const btnVideoGallery = document.querySelector('.stories-slide');
