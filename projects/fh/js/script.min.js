...
const video = document.querySelector('#js-team-video');
const poster = document.querySelector('#js-team-video img');
const iframe = document.querySelector('#vacancies-team-iframe');
...
video.addEventListener('click', e => {
  ...
  iframe.setAttribute('src', srcIframe + '?' + 'autoplay=1');
});

function removePoster() {
  poster.classList.add('vacancies-team__poster--active');
