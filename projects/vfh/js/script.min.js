...
const coachesFormSearchWrapper = coachesFormSearch.querySelector('.form__wrapper');
const btnMoreForm = coachesFormSearch.querySelector('.coaches-form-search__btn-more');
