...
let elementModalStop = document.getElementById('modal-stop');

const modalStop = new bootstrap.Modal(elementModalStop);
...
if (messengers) {
  messengers.addEventListener('click', (e) => {
    ...
    if (messengers.classList.contains('messengers--close')) {
      e.preventDefault();
    }
