  ...
  (function() {
    ...
    function scrollToForm(button) {
      ...
      console.log('Button data attributes:', {
        name: button.getAttribute('data-tariff-name'),
        price: button.getAttribute('data-tariff-price'),
      });
      ...
      if (formSection) {
        ...
        console.log('Scrolling to form with:', tariffName, tariffPrice);
        ...
        setTimeout(() => {
          ...
          console.log('Found select:', tariffSelect);
          ...
          if (tariffSelect && tariffPrice) {
            ...
            if (selectedTariffInfo && selectedTariffText) {
              ...
              console.log('Tariff info updated successfully');
            }
          } else {
            console.warn(
