...
const onCheckValidateForm = form => {
  ...
  console.log(nowAgeUser(dataForm.value));

  console.log(checkPhoneForm);
  ...
  if (!checkPhoneForm || !checkDateForm) {
    ...
    if (!checkPhoneForm) {
      ...
      dataForm.style.borderColor = '';
    } else {
      dataForm.style.borderColor = 'red';
...
document.addEventListener('DOMContentLoaded', () => {
  forms.forEach(form => {
    ...
    form.querySelector('[type="date"]').setAttribute('max', max);
