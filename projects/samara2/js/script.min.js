...
let modalPay = document.getElementById('modal_1');
const fieldDate = modalPay.querySelector('[type="date"]');
const fieldPhone = modalPay.querySelector('[type="tel"]');
...
const postForm = () => {
  //respons width your element posted with and id above 100
  ...
  Array.prototype.slice.call(forms).forEach(function(form) {
    form.addEventListener(
      ...
      e => {
        if (
          !form.checkValidity() ||
          !checkPhone(fieldPhone) ||
          !checkAge(fieldDate.value)
        ) {
          e.preventDefault();
          e.stopPropagation();
          ...
          // modal.hide();
          // modalSubmit.show();
          // fieldPhone.value = fieldPhone.value.replace(/[^+\d]/g, '').length;
          // form.submit(e => {
          //   e.preventDefault();
