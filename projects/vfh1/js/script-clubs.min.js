  ...
  var createPrevieClub = club => {
    return (
      ...
      `</div>
        ...
        <div class="club-preview__footer"><a class="link-text link-text--more" href="#modalPresale" data-bs-toggle="modal" data-toggle="modal"><span>Подобрать абонемент</span>
...
let listItemClub = club => {
  ...
  div.innerHTML =
    `<div class="clubs-result__item">
      <section class="club-preview club-preview--result">
        <div class="club-preview__header">
          <div class="club-preview__info">
            <div class="club-preview__contacts">
              <div class="title">Fitness House ` +
    club.title +
    `</div>
              <div class="raiting">
                <iframe src="https://yandex.ru/sprav/widget/rating-badge/` +
    ...
    `</div>
          ...
          <div class="club-preview__links"><a class="link-text link-text--more" href="#modalToggle" data-bs-toggle="modal" data-toggle="modal"><span>Подобрать абонемент</span>
                        <svg class="icon" width="34" height="8" viewBox="0 0 34 8">
                          <use xlink:href="img/sprite.svg#arrow"></use>
                        </svg></a><a class="link-text link-text--more" href=` +
    club.href +
...
// let region = document.querySelector('.map.map--region');
let sidebar = document.querySelector('.sidebar-clubs');
let sidebarDialog = sidebar.querySelector('.sidebar-clubs__dialog');
let sidebarBody = sidebar.querySelector('.sidebar-clubs__body');
...
// if (region) {
//   for (var i = 0; i < clubs.length; i++) {
//     sidebarBody.append(listItemClub(clubs[i]));
//   }
