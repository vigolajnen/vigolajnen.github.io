    ...
    return (
      ...
      <div class="card-club__header">
        <div class="card-club__title-and-raiting">
          <div class="card-club__title"><span>` + club.title + `</span>` + `</div>
...
let listItemClub = club => {
  ...
  div.innerHTML =
    ...
    <div class="card-club__header">
      <div class="card-club__title-and-raiting">
        <div class="card-club__title"><span>` +
    club.title +
    `</span>` +
    `</div>
        <div class="card-club__raiting">
    ...
    </div><a class="card-club__pic" href=` +
    club.href +
    `><img src=` +
    club.poster +
    ` width="666" height="228px" alt="фитнес-клуб с&nbsp;большим бассейном"></a>
    <div class="card-club__footer">
      <a class="link-icon link-icon--more" href=` +
    club.href +
    `>
        <span>О клубе</span>
        <svg class="icon" width="34" height="8" viewBox="0 0 34 8">
