...
(function() {
  ...
  var phoneNum = document.querySelector('[name=phone-number]');
    ...
    form.addEventListener(
      ...
      function(event) {
        if (!form.checkValidity()) {
          ...
          event.preventDefault();
          const modal = new bootstrap.Modal(modalSubmitForm);
...
ymaps.ready(['Panel']).then(function() {
  ...
  var createPrevieClub = club => {
    ...
    <div class="club-preview__footer"><a class="link-text link-text--more" href="#" data-bs-toggle="modal" data-toggle="modal"><span>Подобрать абонемент</span>
                  <svg class="icon" width="34" height="8" viewBox="0 0 34 8">
                    <use xlink:href="img/sprite.svg#arrow"></use>
                  </svg></a><a class="link-text link-text--more" href="club.html"><span>О клубе</span>
                  <svg class="icon" width="34" height="8" viewBox="0 0 34 8">
                    <use xlink:href="img/sprite.svg#arrow"></use>
                  </svg></a></div>
  </section>
  ...
  for (var i = 0; i < clubs.length; i++) {
    collection.add(
      new ymaps.Placemark(clubs[i].center, {
...
(function() {
  ...
  const breakpointChecker = function() {
    ...
    if (breakpoint.matches === true) {
      ...
      if (gallery !== undefined) gallery.destroy(true, true);
  ...
  const enableSwiper = function() {
    gallery = new Swiper('.gallery-clubs-preview .swiper-container', {
      loop: true,
      spaceBetween: 30,
      slidesPerView: 1,
...
// new Swiper('.gallery-clubs-preview .swiper-container', {
//   spaceBetween: 14,
//   slidesPerView: 1,
//   loop: true,
