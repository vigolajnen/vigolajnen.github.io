...
// let modalFilterListClubs = new bootstrap.Modal(
//   document.querySelector('#modal-filter-list-clubs'),
// );
...
let btn = document.querySelector('[data-target="sidebar-list"]');
let btnMobile = document.querySelector('[data-target="sidebar-list-modal"]');
let btnMap = document.querySelector('[data-target="map"]');
...
if (btn && window.matchMedia('(min-width: 600px)').matches) {
  if (sidebar.classList.contains('show')) {
    sidebar.classList.remowe('show');
  }
