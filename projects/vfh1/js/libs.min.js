...
(function() {
  ...
  //   const slides = sliderSaleContainer.querySelectorAll('.swiper-slide');
  ...
  // let sliderSale = new Swiper('#slider-sale .swiper-container', sliderParams);
