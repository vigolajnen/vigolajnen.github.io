...
const templateLesson = lesson => {
  return (
    `<div class="lesson ` + lesson.dopClass +`" data-type="` + lesson.type +`" data-bs-content-id="popover-content-`+ lesson.number +`" tabindex="0" role="button" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="focus">
...
<div class="schedule__inner">
  ...
  <div class="schedule__week" id="scroll-wrapper">
    ...
    <div class="schedule__week-days week-days">
      <div class="week-days__item"><span class="week-days__item-date">22.05</span><span class="d-none d-sm-flex px-2">пн</span><span class="d-flex d-sm-none px-2">Понедельник</span></div>
      <div class="week-days__item"><span class="week-days__item-date">23.05</span><span class="d-none d-sm-flex px-2">вт</span><span class="d-flex d-sm-none px-2">Вторник</span></div>
      <div class="week-days__item"><span class="week-days__item-date">24.05</span><span class="d-none d-sm-flex px-2">ср</span><span class="d-flex d-sm-none px-2">Среда</span></div>
      <div class="week-days__item"><span class="week-days__item-date">25.05</span><span class="d-none d-sm-flex px-2">чт</span><span class="d-flex d-sm-none px-2">Четверг</span></div>
      <div class="week-days__item"><span class="week-days__item-date">26.05</span><span class="d-none d-sm-flex px-2">пт</span><span class="d-flex d-sm-none px-2">Пятница</span></div>
      <div class="week-days__item"><span class="week-days__item-date">27.05</span><span class="d-none d-sm-flex px-2">сб</span><span class="d-flex d-sm-none px-2">Суббота</span></div>
      <div class="week-days__item"><span class="week-days__item-date">28.05</span><span class="d-none d-sm-flex px-2">вс</span><span class="d-flex d-sm-none px-2">Воскресенье</span></div>
    </div>
