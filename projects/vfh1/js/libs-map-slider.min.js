...
(function() {
  ...
  let sliderHeightAuto = new Swiper('slider-h-auto .swiper-container', {
  ...
  let gallery = new Swiper('.gallery-clubs-preview .swiper-container', {
  ...
  const sliderSaleContainer = document.querySelector(
    '#slider-sale .swiper-container',
  );
  const sliderClubContainer = document.querySelector(
    '#slider-club .swiper-container',
  );


  let sliderSale = new Swiper('#slider-sale .swiper-container', {
    slideToClickedSlide: true,
    slidesPerView: 1,
    loop: true,
    autoHeight: true,
  ...
  if (sliderSaleContainer) {
    sliderSaleContainer.addEventListener('mouseenter', function(e) {
      sliderSale.autoplay.stop();
    });
    sliderSaleContainer.addEventListener('mouseleave', function(e) {
      sliderSale.autoplay.start();
    });
  }
  if (sliderClubContainer) {
    sliderClubContainer.addEventListener('mouseenter', function(e) {
      mySwiper.autoplay.stop();
    });
    sliderClubContainer.addEventListener('mouseleave', function(e) {
