...
const clubs = [
  {
    id: 1,
    organizationID: '174268412760',
    cityTitle: 'Ульяновск',
    title: 'Октябрьская',
    metro: ['Нет метро'],
    address: 'ул. Октябрьская д. 22 Г, к.1',
    pool: 'С бассейном',
    ...
    center: [54.296556,48.329066],
    poster: 'img/club/preview/3.jpg',
    href: 'club.html',
  },
  {
    id: 2,
    organizationID: '244194202818',
    cityTitle: 'Ульяновск',
    title: 'Созидателей',
    metro: ['Нет метро'],
    address: 'пр. Созидателей, д. 116',
    pool: 'С бассейном',
    working: 'ПН-ПТ 07:00–23:00СБ-ВС 08:00–22:00',
    text:
    ...
    center: [54.359509,48.564613],
    poster: 'img/club/preview/2.jpg',
    href: 'club.html',
  },
];
  ...
  return (
    ...
    `</div>
      ...
      <div class="club-preview__body">
        <a href=` +
    club.href +
    ` class="club-preview__pic"><img src="` +
    club.poster +
    ...
    `</div>
      ...
      <div class="club-preview__footer"><a class="link-text link-text--more" href="#modalPresale" data-bs-toggle="modal" data-bs-dismiss="modal"><span>Подобрать абонемент</span>
...
ymaps.ready(['Panel']).then(function() {
  var map = new ymaps.Map('map', {
    center: [54.35937509, 48.56449782],
    zoom: 11,
    controls: ['zoomControl'],
  });

  let modal = new bootstrap.Modal(
    document.querySelector('#modal-preview-club'),
  );
  ...
  collection.events.add('click', function(e) {
    ...
    let modalBaseContent = document.querySelector('.modal-body .club-preview');
    ...
    if (window.matchMedia('(min-width: 768px)').matches) {
      ...
      if (modal) {
        ...
        modal.addEventListener('hidden.bs.modal', function() {
          target.options.set({ iconImageHref: 'img/icons/map-pin.svg' });
        });
      }
    }
